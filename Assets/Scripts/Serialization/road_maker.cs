    ...
    IEnumerator Start()
    {
        ...
        foreach (var way in map.ways.FindAll((w)=> {return w.is_road;}))
        {
            ...
            for (int i = 1; i < way.node_ids.Count; i++)
            {
                ...
                vectors.Add(v1 + new Vector3(0,0.1f,0));
                vectors.Add(v2 + new Vector3(0,0.1f,0));
                vectors.Add(v3 + new Vector3(0,0.1f,0));
                vectors.Add(v4 + new Vector3(0,0.1f,0));
